---
layout: post
title:  "Signing images and creating  SBOM using cosign"
description: "Signing images and creating  SBOM using cosign"
author: juned
categories: [ k8s ]
tags: [k8s]
...
We can automate all these steps in the CI pipeline to achieve the [SLSA](https://slsa.dev/spec/v0.1/levels)
